...
const STEPS: Step[] = [
  ...
  {
    n: '۴', title: 'استقرار روی Railway و Render', icon: <Cloud className="w-4 h-4" />,
    body: (
      <>
        برای بالا آوردن پنل StanNG روی سرویس میزبانی، از «استقرار جدید» ارائه‌دهنده را انتخاب کنید. با یک توکن معتبر Railway یا کلید API رندر، ساخت سرویس، تنظیم پورت، دیپلوی و لینک پنل ثبت می‌شود؛ نتیجه را بعداً در «ورکرها» و «داشبورد» هم می‌بینید. تنظیمات KV و اعضا فقط برای ورکرهای Cloudflare فعال است.
      </>
    ),
  },
  {
    n: '۵', title: 'مدیریت ورکرها', icon: <Cloud className="w-4 h-4" />,
    body: (
      <>
  ...
  {
    n: '۶', title: 'بهینه‌ساز و ساب گروهی', icon: <Zap className="w-4 h-4" />,
    body: (
      <>
  ...
  {
    n: '۷', title: 'کاربران ورکر (اعضا)', icon: <UsersRound className="w-4 h-4" />,
    body: (
      <>
  ...
  {
    n: '۸', title: 'ربات تلگرام', icon: <Bot className="w-4 h-4" />,
    body: (
      <>
