...
const MIGRATIONS = [
  ...
  `ALTER TABLE deployments ADD COLUMN worker_source TEXT NOT NULL DEFAULT 'edgetunnel'`,
  `ALTER TABLE deployments ADD COLUMN panel_url TEXT`,
  `ALTER TABLE deployments ADD COLUMN custom_domain TEXT`,
